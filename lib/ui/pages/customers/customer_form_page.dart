...
class _CustomerFormPageState extends State<CustomerFormPage> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      context.go('/clientes'); // volta para lista
    } catch (e) {
      if (mounted) {
          ...
          children: [
            ...
            Row(
              children: [
                ...
                TextButton.icon(onPressed: () => context.go('/clientes'), icon: const Icon(Icons.arrow_back), label: const Text('Voltar')),
              ],
            ),
          ],
        ),
  ...
  Widget _field(Widget child, {int flex = 1}) {
    return SizedBox(
      width: 280.0 * flex, // ajuda a montar grid fluido em desktop
      child: child,
    );
  }
}
